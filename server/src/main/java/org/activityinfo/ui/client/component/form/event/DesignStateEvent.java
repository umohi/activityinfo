 ...
 */
public class DesignStateEvent extends GwtEvent<DesignStateEvent.Handler> {
    ...
    public static interface Handler extends EventHandler {
         ...
         */
        void update(DesignStateEvent p_event);
    }
    ...
    private final boolean designEnabled;

    /**
     * Constructor
     */
    public DesignStateEvent(boolean designEnabled) {
