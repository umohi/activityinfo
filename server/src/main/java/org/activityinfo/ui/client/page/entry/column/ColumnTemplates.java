...
public interface ColumnTemplates extends SafeHtmlTemplates {
    ...
    @Template("<span>{0}<br><i>{1}</i></span>") SafeHtml locationCell(String location, String axe);

    @Template("<span qtip=\"{0}\">{1}</span>") SafeHtml adminCell(String quickTip, SafeHtml summary);
