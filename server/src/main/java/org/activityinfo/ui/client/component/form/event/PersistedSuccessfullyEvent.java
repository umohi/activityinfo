 ...
 */
public class PersistedSuccessfullyEvent extends GwtEvent<PersistedSuccessfullyEvent.Handler> {
    ...
    public static interface Handler extends EventHandler {
         ...
         */
        void persist(PersistedSuccessfullyEvent p_event);
    }
     ...
     * Constructor
     */
    public PersistedSuccessfullyEvent() {
    }
