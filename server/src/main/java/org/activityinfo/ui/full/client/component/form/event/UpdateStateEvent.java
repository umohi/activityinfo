package org.activityinfo.ui.full.client.component.form.event;
/*
 * #%L
 * ActivityInfo Server
 * %%
 ...
 */
public class UpdateStateEvent extends GwtEvent<UpdateStateEvent.Handler> {
    ...
    public static interface Handler extends EventHandler {
         ...
         */
        void update(UpdateStateEvent p_event);
    }
