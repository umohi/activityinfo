package org.activityinfo.analysis.server.renderer.ppt;
...
import org.activityinfo.analysis.server.generator.map.IconRectCalculator;
...
public class PPTMapRenderer extends ImageMapRenderer {
    ...
    private void addIconMarker(SlideShow ppt, Slide slide, int offsetX,
        ...
        if (iconIndex != -1) {
            ...
            org.activityinfo.analysis.shared.model.Rectangle iconRect = rectCtor
                    .iconRect(
                            offsetX + marker.getX(),
                            offsetY + marker.getY());
