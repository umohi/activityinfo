package org.activityinfo.analysis.server.generator.map.cluster;
...
import org.activityinfo.analysis.server.generator.map.RadiiCalculator;
import org.activityinfo.analysis.server.generator.map.TiledMap;
import org.activityinfo.analysis.server.generator.map.cluster.genetic.BubbleFitnessFunctor;
import org.activityinfo.analysis.server.generator.map.cluster.genetic.GeneticSolver;
import org.activityinfo.analysis.server.generator.map.cluster.genetic.MarkerGraph;
import org.activityinfo.analysis.server.generator.map.cluster.genetic.MarkerGraph.IntersectionCalculator;
import org.activityinfo.analysis.server.generator.map.cluster.genetic.UpperBoundsCalculator;
import org.activityinfo.analysis.shared.model.PointValue;
...
public class GeneticClusterer implements Clusterer {
     ...
     * 
     * @see
     * org.activityinfo.analysis.shared.model.clustering.Clustering#cluster(java
