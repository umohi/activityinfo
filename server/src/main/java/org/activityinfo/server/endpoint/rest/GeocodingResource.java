...
public class GeocodingResource {
    ...
    @GET @JsonView(AdminEntityViews.GeocodeView.class) @Produces(MediaType.APPLICATION_JSON)
    ...
    @POST @JsonView(AdminEntityViews.GeocodeView.class) @Consumes(MediaType.APPLICATION_JSON)
    @Produces(MediaType.APPLICATION_JSON)
    public List<List<AdminEntity>> geocodeBatch(@InjectParam Geocoder geocoder, List<AiLatLng> points) {
