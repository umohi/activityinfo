 ...
 * as:
 * <ul>
 * <li>{@link org.activityinfo.api.shared.command.AddPartner}</li>
 * <li>{@link UpdateUserPermissions}</li>
 * <li>{@link org.activityinfo.api.shared.command.CreateReport}</li>
 * </ul>
 * <p/>
 * Returns {@link org.activityinfo.api.shared.command.result.CreateResult}
 *
