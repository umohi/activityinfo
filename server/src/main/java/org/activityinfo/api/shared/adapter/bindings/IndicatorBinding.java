 ...
 */
public class IndicatorBinding extends ModelBinding<IndicatorDTO> {

    private IndicatorDTO indicatorDTO;

    public IndicatorBinding(IndicatorDTO indicatorDTO) {
        super(CuidAdapter.indicatorField(indicatorDTO.getId()), CuidAdapter.INDICATOR_DOMAIN);
