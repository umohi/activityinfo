 ...
 * {@link org.activityinfo.api.shared.command.RemoteCommandService} interface for
 * each server-side operation, we define a single
 * {@link org.activityinfo.api.shared.command.RemoteCommandService#execute(String, java.util.List)}
