    ...
    <div class="row">
        ...
        <div class="span4">
            ...
            <ul>
                ...
                <li><a href="/admin/reports/activities/mostActiveSince?days=365">Most active in the last 365 days</a>
                </li>
            </ul>
            <ul>
                ...
                <li><a href="/admin/reports/activities/leastActiveSince?days=90">Least active in the last 90 days</a>
                </li>
                <li><a href="/admin/reports/activities/leastActiveSince?days=365">Least active in the last 365 days</a>
                </li>
            </ul>
            <ul>
        ...
        <div class="span4">
            ...
            <ul>
                ...
                <li><a href="/admin/reports/databases/mostActiveSince?days=365">Most active in the last 365 days</a>
                </li>
            </ul>
            <ul>
                ...
                <li><a href="/admin/reports/databases/leastActiveSince?days=90">Least active in the last 90 days</a>
                </li>
                <li><a href="/admin/reports/databases/leastActiveSince?days=365">Least active in the last 365 days</a>
                </li>
            </ul>
            <ul>
